...
spaces = open('greenspaces.geojson')
...
def checkLat(lat):
    return lat > 56.478810 and lat < 56.481638

def checkLong(long):
    return long > -2.989885 and long < -2.979647
...
allFeatures = t["features"][0]

for feature in allFeatures:
    if checkDataPoint(feature):
        print(feature)

#for coords in t["features"][0]["geometry"]["coordinates"][0][0]:


print(checkCoords(c))
print(checkFunction("Play Space"))
print(checkDataPoint(t["features"][0]))
